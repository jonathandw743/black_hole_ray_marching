...
pub struct Bloom<const LEVELS: usize> {
    ...
    pub downsampling: KawaseDownsampling<LEVELS>,
    pub upsampling: KawaseMixingUpsampling<LEVELS>,
...
impl<const LEVELS: usize> Bloom<LEVELS> {
    pub fn new(device: &wgpu::Device, config: &wgpu::SurfaceConfiguration) -> Self {
        ...
        let upsampling = KawaseMixingUpsampling::new(device, config, downsampling.input_texture_view());
    ...
    pub fn resize(&mut self, device: &wgpu::Device, config: &wgpu::SurfaceConfiguration, queue: &wgpu::Queue) {
        ...
        self.upsampling
            .resize(device, config, queue, self.downsampling.input_texture_view());
